...
from .. import db
from .forms import LoginForm, RegistrationForm, PasswordChangeForm, PasswordResetForm, PasswordResetRequestForm, EmailChangeForm
...
def change_email_request():
    ...
    if form.validate_on_submit():
        if current_user.verify_password(form.password.data):
            ...
            send_email(new_email, 'Change You Email',
